      ...
      await Stock.findOneAndUpdate(
        ...
        },
        {
          ...
          $set: {
            ...
            PRate: Number(item.purRate || item.selectedBatch?.purchaseRate || 0),
            SRate: Number(item.salesRate || item.selectedBatch?.salesRate || 0),
            IsLocked: item.isLocked || item.selectedBatch?.isLocked || "N",
            BoxPack: Number(item.boxPack || item.selectedBatch?.boxPack || 1),
            InBoxPack: Number(item.inBoxPack || item.inboxPack || item.ratePerUnit || 1),
          },
