...
const transactionDefinitions = {
  ...
  DesktopReceipt: { endpoint: "/transaction/receipt", nested: "receiptBills", identity: ["receiptSeries", "rno"], required: ["rno", "partyId", "receiptBills"], collection: "T_Receipt", duplicate: ["receiptSeries", "rno"], deleteEndpoint: "/transaction/receipt" },
