...
export const importConfig = {
  Company: { label: "Company Master", collection: "Mas_Company", duplicateField: "companyCode", sampleFileName: "Company_Master_Sample.xlsx", columns: [text("Company Code", "companyCode", true), text("Company Name", "companyName", true), text("Head Office Address", "companyAddress"), text("Branch Office Address", "branchOfficeAddress"), text("GSTIN", "gstNo"), text("State", "state"), text("PIN Code", "pinCode")] },
  Category: { label: "Category Master", collection: "Mas_Category", duplicateField: "categoryCode", sampleFileName: "Category_Master_Sample.xlsx", columns: [text("Category Code", "categoryCode", true), text("Category Name", "categoryName", true)] },
  Group: { label: "Group Master", collection: "Mas_Group", duplicateField: "groupCode", sampleFileName: "Group_Master_Sample.xlsx", columns: [text("Group Code", "groupCode", true), text("Group Name", "groupName", true)] },
